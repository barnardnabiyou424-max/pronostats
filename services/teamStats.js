...
const WORLD_CUP = {
  // ── TOP FIFA AVRIL 2026 ──
  'France':             { moy_buts_dom: 2.3, moy_buts_enc_dom: 0.7, moy_buts_ext: 1.9, moy_buts_enc_ext: 0.9, elo: 1950 },
  'Spain':              { moy_buts_dom: 2.4, moy_buts_enc_dom: 0.6, moy_buts_ext: 2.0, moy_buts_enc_ext: 0.8, elo: 1948 },
  'Argentina':          { moy_buts_dom: 2.3, moy_buts_enc_dom: 0.7, moy_buts_ext: 1.9, moy_buts_enc_ext: 0.9, elo: 1946 },
  'England':            { moy_buts_dom: 2.1, moy_buts_enc_dom: 0.8, moy_buts_ext: 1.7, moy_buts_enc_ext: 1.0, elo: 1900 },
  'Portugal':           { moy_buts_dom: 2.5, moy_buts_enc_dom: 0.8, moy_buts_ext: 2.0, moy_buts_enc_ext: 1.0, elo: 1860 },
  'Brazil':             { moy_buts_dom: 2.2, moy_buts_enc_dom: 0.7, moy_buts_ext: 1.8, moy_buts_enc_ext: 0.9, elo: 1858 },
  'Netherlands':        { moy_buts_dom: 2.1, moy_buts_enc_dom: 0.9, moy_buts_ext: 1.7, moy_buts_enc_ext: 1.1, elo: 1854 },
  'Morocco':            { moy_buts_dom: 1.8, moy_buts_enc_dom: 0.6, moy_buts_ext: 1.4, moy_buts_enc_ext: 0.8, elo: 1852 },
  'Belgium':            { moy_buts_dom: 2.0, moy_buts_enc_dom: 0.8, moy_buts_ext: 1.6, moy_buts_enc_ext: 1.0, elo: 1830 },
  'Germany':            { moy_buts_dom: 2.3, moy_buts_enc_dom: 1.0, moy_buts_ext: 1.9, moy_buts_enc_ext: 1.1, elo: 1826 },
  'Croatia':            { moy_buts_dom: 1.8, moy_buts_enc_dom: 0.9, moy_buts_ext: 1.5, moy_buts_enc_ext: 1.1, elo: 1814 },
  'Colombia':           { moy_buts_dom: 1.9, moy_buts_enc_dom: 0.9, moy_buts_ext: 1.5, moy_buts_enc_ext: 1.1, elo: 1790 },
  'Senegal':            { moy_buts_dom: 1.7, moy_buts_enc_dom: 0.8, moy_buts_ext: 1.4, moy_buts_enc_ext: 1.0, elo: 1786 },
  'Mexico':             { moy_buts_dom: 1.9, moy_buts_enc_dom: 0.9, moy_buts_ext: 1.5, moy_buts_enc_ext: 1.1, elo: 1778 },
  'USA':                { moy_buts_dom: 1.8, moy_buts_enc_dom: 1.0, moy_buts_ext: 1.4, moy_buts_enc_ext: 1.2, elo: 1770 },
  'Uruguay':            { moy_buts_dom: 1.8, moy_buts_enc_dom: 0.9, moy_buts_ext: 1.4, moy_buts_enc_ext: 1.1, elo: 1770 },
  'Japan':              { moy_buts_dom: 2.0, moy_buts_enc_dom: 0.8, moy_buts_ext: 1.6, moy_buts_enc_ext: 1.0, elo: 1757 },
  'Switzerland':        { moy_buts_dom: 1.8, moy_buts_enc_dom: 0.9, moy_buts_ext: 1.4, moy_buts_enc_ext: 1.1, elo: 1746 },
  'Iran':               { moy_buts_dom: 1.6, moy_buts_enc_dom: 0.9, moy_buts_ext: 1.2, moy_buts_enc_ext: 1.1, elo: 1720 },
  'South Korea':        { moy_buts_dom: 1.8, moy_buts_enc_dom: 1.0, moy_buts_ext: 1.4, moy_buts_enc_ext: 1.2, elo: 1710 },
  'Ecuador':            { moy_buts_dom: 1.6, moy_buts_enc_dom: 1.0, moy_buts_ext: 1.3, moy_buts_enc_ext: 1.2, elo: 1700 },
  'Austria':            { moy_buts_dom: 1.8, moy_buts_enc_dom: 1.0, moy_buts_ext: 1.4, moy_buts_enc_ext: 1.2, elo: 1695 },
  'Turkey':             { moy_buts_dom: 1.8, moy_buts_enc_dom: 1.0, moy_buts_ext: 1.4, moy_buts_enc_ext: 1.2, elo: 1690 },
  'Australia':          { moy_buts_dom: 1.6, moy_buts_enc_dom: 1.1, moy_buts_ext: 1.2, moy_buts_enc_ext: 1.3, elo: 1670 },
  'Canada':             { moy_buts_dom: 1.6, moy_buts_enc_dom: 1.1, moy_buts_ext: 1.3, moy_buts_enc_ext: 1.2, elo: 1660 },
  'Norway':             { moy_buts_dom: 2.2, moy_buts_enc_dom: 1.0, moy_buts_ext: 1.7, moy_buts_enc_ext: 1.1, elo: 1658 },
  'Algeria':            { moy_buts_dom: 1.6, moy_buts_enc_dom: 1.0, moy_buts_ext: 1.2, moy_buts_enc_ext: 1.2, elo: 1640 },
  'Egypt':              { moy_buts_dom: 1.5, moy_buts_enc_dom: 1.0, moy_buts_ext: 1.2, moy_buts_enc_ext: 1.2, elo: 1635 },
  'Scotland':           { moy_buts_dom: 1.6, moy_buts_enc_dom: 1.1, moy_buts_ext: 1.3, moy_buts_enc_ext: 1.2, elo: 1620 },
  'Sweden':             { moy_buts_dom: 1.7, moy_buts_enc_dom: 1.0, moy_buts_ext: 1.3, moy_buts_enc_ext: 1.2, elo: 1615 },
  'Czech Republic':     { moy_buts_dom: 1.6, moy_buts_enc_dom: 1.1, moy_buts_ext: 1.3, moy_buts_enc_ext: 1.3, elo: 1610 },
  'Paraguay':           { moy_buts_dom: 1.4, moy_buts_enc_dom: 1.1, moy_buts_ext: 1.1, moy_buts_enc_ext: 1.3, elo: 1580 },
  'Tunisia':            { moy_buts_dom: 1.5, moy_buts_enc_dom: 1.0, moy_buts_ext: 1.1, moy_buts_enc_ext: 1.2, elo: 1575 },
  'Ivory Coast':        { moy_buts_dom: 1.6, moy_buts_enc_dom: 1.1, moy_buts_ext: 1.2, moy_buts_enc_ext: 1.3, elo: 1570 },
  'Ghana':              { moy_buts_dom: 1.5, moy_buts_enc_dom: 1.2, moy_buts_ext: 1.2, moy_buts_enc_ext: 1.3, elo: 1555 },
  'DR Congo':           { moy_buts_dom: 1.5, moy_buts_enc_dom: 1.1, moy_buts_ext: 1.1, moy_buts_enc_ext: 1.3, elo: 1545 },
  'Saudi Arabia':       { moy_buts_dom: 1.5, moy_buts_enc_dom: 1.1, moy_buts_ext: 1.1, moy_buts_enc_ext: 1.3, elo: 1530 },
  'Bosnia-Herzegovina': { moy_buts_dom: 1.5, moy_buts_enc_dom: 1.2, moy_buts_ext: 1.1, moy_buts_enc_ext: 1.3, elo: 1525 },
  'Iraq':               { moy_buts_dom: 1.4, moy_buts_enc_dom: 1.1, moy_buts_ext: 1.1, moy_buts_enc_ext: 1.3, elo: 1520 },
  'Uzbekistan':         { moy_buts_dom: 1.4, moy_buts_enc_dom: 1.1, moy_buts_ext: 1.1, moy_buts_enc_ext: 1.3, elo: 1515 },
  'Qatar':              { moy_buts_dom: 1.5, moy_buts_enc_dom: 1.2, moy_buts_ext: 1.1, moy_buts_enc_ext: 1.4, elo: 1510 },
  'Jordan':             { moy_buts_dom: 1.4, moy_buts_enc_dom: 1.1, moy_buts_ext: 1.0, moy_buts_enc_ext: 1.3, elo: 1505 },
  'Panama':             { moy_buts_dom: 1.3, moy_buts_enc_dom: 1.2, moy_buts_ext: 1.0, moy_buts_enc_ext: 1.4, elo: 1500 },
  'Cape Verde':         { moy_buts_dom: 1.4, moy_buts_enc_dom: 1.1, moy_buts_ext: 1.0, moy_buts_enc_ext: 1.3, elo: 1495 },
  'South Africa':       { moy_buts_dom: 1.4, moy_buts_enc_dom: 1.2, moy_buts_ext: 1.0, moy_buts_enc_ext: 1.3, elo: 1490 },
  'New Zealand':        { moy_buts_dom: 1.3, moy_buts_enc_dom: 1.3, moy_buts_ext: 1.0, moy_buts_enc_ext: 1.4, elo: 1475 },
  'Scotland':           { moy_buts_dom: 1.6, moy_buts_enc_dom: 1.1, moy_buts_ext: 1.3, moy_buts_enc_ext: 1.2, elo: 1620 },
  'Haiti':              { moy_buts_dom: 1.2, moy_buts_enc_dom: 1.4, moy_buts_ext: 0.9, moy_buts_enc_ext: 1.5, elo: 1440 },
  'Curaçao':            { moy_buts_dom: 1.1, moy_buts_enc_dom: 1.5, moy_buts_ext: 0.8, moy_buts_enc_ext: 1.6, elo: 1410 },
};
// ─────────────────────────────────────────────
